// 1. นําเข้า Express.js (เป็น Framework เครื่องมือทุ่นแรงที่ช่วยให้เราสร้าง Web Server ได้ง่ายและ
สั้นลง)
...
response.send(`
  <div style="font-family: sans-serif; text-align: center; margin-top: 50px;">
    ...
    <p><strong>รหัสนักศึกษา:</strong> [ใส่รหัสนักศึกษาของตัวเองที่นี่]</p>
    <p><strong>ชื่อ-นามสกุล:</strong> [ใส่ชื่อของตัวเองที่นี่]</p>
  </div>
  `);
});
